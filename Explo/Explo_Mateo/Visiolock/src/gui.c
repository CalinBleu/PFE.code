...
typedef enum  {E_SCREEN_ON = 0, E_SREEN_OFF, E_USER_TAG_OK, E_USER_TAG_UNKNOWN, E_FACE_UNKNOWN, E_USER_ALLOWED, E_USER_TAG_DENIED, E_ADMIN_TAG, E_ADMIN_MODE, E_QUIT_ADMIN_MODE, E_MANAGEMENT_USER, E_ASK_MODIFY_USER, E_MODIFY_USER, E_ASK_ADD_USER, E_ADD_USER, E_VALIDATE, E_CANCEL, E_ASK_TAKE_PICTURE, E_TAKE_PICTURE, E_ASK_DELETE_USER, E_REMOVE_USER, E_STOP, EVENT_NB} Event;
