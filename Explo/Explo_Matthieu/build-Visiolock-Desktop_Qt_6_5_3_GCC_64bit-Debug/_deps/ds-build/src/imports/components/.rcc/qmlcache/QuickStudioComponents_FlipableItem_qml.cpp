...
0x88,0xf,0x0,0x0,0x64,0x66,0x61,0x33,
...
while (!aotContext->setObjectLookup(15, r7_0, &converted)) {
aotContext->setInstructionPointer(17);
aotContext->initSetObjectLookup(15, r7_0, []() { static const auto t = QMetaType::fromName("QQuickItem*"); return t; }());
if (aotContext->engine->hasError())
    return ;
}
}
...
aotContext->initGetObjectLookup(18, r2_0, QMetaType::fromType<QQmlListProperty<QObject>>());
if (aotContext->engine->hasError())
    return ;
}
// generate_StoreReg
...
{
auto converted = aotContext->engine->fromVariant<QObject *>(r2_3);
while (!aotContext->setObjectLookup(19, r7_0, &converted)) {
aotContext->setInstructionPointer(36);
aotContext->initSetObjectLookup(19, r7_0, []() { static const auto t = QMetaType::fromName("QQuickItem*"); return t; }());
if (aotContext->engine->hasError())
    return ;
}
}
